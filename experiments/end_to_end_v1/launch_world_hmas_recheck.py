...
REFERENCE = "/home/lsh/.aeroweaver-experiments/end-to-end-pilot/20260910-125042"
...
def main():
    ...
    try:
        ssh.connect("10.61.3.7", username="lsh", password=os.environ.get("AEROWEAVER_DEPLOY_PASSWORD"),
    ...
    remote = "/home/lsh/.aeroweaver-experiments/world-hmas-single-recheck/" + stamp
    ...
    try:
        ...
        command = shlex.join(["timeout", "--signal=TERM", "--kill-after=10s", "950s", "env",
                              "AEROWEAVER_REPO_ROOT=/home/lsh/AeroWeaver", PYTHON, "-u",
