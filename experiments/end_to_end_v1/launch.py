...
def main():
    ...
    remote = "/home/runner/.aeroweaver-experiments/end-to-end-pilot/" + stamp
    ...
    try:
        ...
        with ssh.open_sftp() as sftp:
            ...
            bm25 = "/home/runner/.venvs/aeroweaver-skill-eval/lib/python3.10/site-packages/rank_bm25.py"
        ...
        save(local / "launch.json", {"remote": remote, "commands": commands, "host": "192.0.2.10"})
