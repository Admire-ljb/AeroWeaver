...
def main():
    ...
    remote = '/home/runner/.aeroweaver-experiments/private-recheck/' + stamp
    stage = remote + '/stage'
    ...
    save(local / 'launch.json', {'remote': remote, 'stage': stage, 'model': MODEL, 'host': '192.0.2.10'})
    ...
    try:
        ...
        with ssh.open_sftp() as sftp:
            ...
            with sftp.open('/home/runner/.venvs/aeroweaver-skill-eval/lib/python3.10/site-packages/rank_bm25.py', 'rb') as src:
                with sftp.open(remote + '/inputs/rank_bm25.py', 'wb') as dest:
                    dest.write(src.read())
            activation = '/home/runner/.aeroweaver-experiments/end-to-end-pilot/20260910-125042/outputs/shared_activations/private_communication.json'
