...
def main():
    ...
    remote = "/home/lsh/.aeroweaver-experiments/skill-activation-closed-loop/" + stamp
    ...
    try:
        ...
        with ssh.open_sftp() as sftp:
            ...
            dependency_path = "/home/lsh/.venvs/aeroweaver-skill-eval/lib/python3.10/site-packages/rank_bm25.py"
        ...
        save(local / "launch.json", {"host": "10.61.3.7", "remote": remote, "commands": commands,
