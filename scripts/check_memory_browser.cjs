const { chromium } = require('C:/Users/researcher/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/node_modules/playwright')
...
async function main() {
  ...
  try {
    await page.goto('http://192.0.2.10:5001', { waitUntil: 'domcontentloaded' })
