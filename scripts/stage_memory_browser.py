...
LIVE = "/home/runner/AeroWeaver"
RUN = ROOT / "results/memory-browser/20260909-124908"
STAGE = "/home/runner/.aeroweaver-memory-browser-20260909-124908"
    ...
    try:
        with ssh.open_sftp() as sftp:
            ...
            if args.mode == "prepare":
                ...
                run("/home/runner/.venvs/aeroweaver/bin/python -c " + shlex.quote(command))
                ...
                command = f"cd {shlex.quote(STAGE)} && PYTHONPATH={shlex.quote(STAGE + '/backend')} /home/runner/.venvs/aeroweaver/bin/python -m pytest tests -q"
                result = run(command)
                ...
                result = run(f"/home/runner/.venvs/aeroweaver/bin/python {shlex.quote(STAGE + '/install.py')} {shlex.quote(STAGE)}")
