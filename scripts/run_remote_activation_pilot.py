...
VENV = "/home/lsh/.venvs/aeroweaver-skill-eval"
BACKEND = "/home/lsh/AeroWeaver/backend"
...
def main():
    ...
    try:
        if args.prepare:
            ...
            remote = f"/home/lsh/.aeroweaver-experiments/skill-activation-{stamp}"
            ...
            if not remote.startswith("/home/lsh/.aeroweaver-experiments/skill-activation-"):
