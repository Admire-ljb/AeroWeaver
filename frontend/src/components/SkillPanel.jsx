...
const SKILL_PARAMS = {
  ...
  swarm_area_search: { robot_ids: 'UAV_1,UAV_2,UAV_3,UAV_4', area_center: [30, 30, -12], area_width: 80.0, area_height: 60.0, altitude: 12.0, speed: 20.0, tracks_per_uav: 4 },
...
const SKILL_DESCRIPTIONS = {
  ...
  swarm_area_search: 'Divide a rectangular area among active UAVs and animate parallel lawnmower coverage in Mock mode.',
...
const SKILL_DESCRIPTIONS_ZH = {
  ...
  swarm_area_search: '\u5c06\u77e9\u5f62\u533a\u57df\u5206\u7ed9\u591a\u67b6\u65e0\u4eba\u673a\uff0c\u5728 Mock \u6a21\u5f0f\u4e2d\u4ee5\u5f80\u590d\u626b\u63cf\u8f68\u8ff9\u5b8c\u6210\u8986\u76d6\u3002',
