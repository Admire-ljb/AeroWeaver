...
const SKILL_PARAMS = {
  ...
  set_fleet_size:   { count: 4, reason: 'Scale the fleet for mission coverage.' },
  swarm_area_search: { robot_ids: 'UAV_1,UAV_2,UAV_3,UAV_4', area_center: [30, 30, -12], area_width: 80.0, area_height: 60.0, altitude: 12.0, speed: 20.0, tracks_per_uav: 4, formation: 'coverage', formation_spacing: 12.0 },
  swarm_perimeter_patrol: { robot_ids: 'UAV_1,UAV_2,UAV_3,UAV_4', area_center: [30, 30, -15], area_width: 100.0, area_height: 80.0, altitude: 15.0, speed: 20.0, patrol_laps: 1, visual_duration: 10.0 },
  swarm_waypoint_inspection: { robot_ids: 'UAV_1,UAV_2,UAV_3,UAV_4', inspection_points: [[10,10,-18],[50,10,-18],[50,50,-18],[10,50,-18]], altitude: 18.0, speed: 18.0, visual_duration: 10.0 },
  swarm_relay_deploy: { robot_ids: 'UAV_1,UAV_2,UAV_3,UAV_4', start_position: [0,0,-18], end_position: [100,60,-18], min_spacing: 10.0, speed: 18.0, visual_duration: 8.0 },
  swarm_escort_route: { robot_ids: 'UAV_1,UAV_2,UAV_3,UAV_4', route: [[0,0,-20],[40,20,-20],[80,10,-20],[110,50,-20]], formation: 'v', spacing: 12.0, speed: 18.0, visual_duration: 12.0 },
...
const SKILL_LABELS = {
  ...
  set_fleet_size:   'Set Fleet Size',
  swarm_area_search: 'Swarm Area Search',
  swarm_perimeter_patrol: 'Perimeter Patrol',
  swarm_waypoint_inspection: 'Waypoint Inspection',
  swarm_relay_deploy: 'Relay Deployment',
  swarm_escort_route: 'Formation Escort',
...
const SKILL_LABELS_ZH = {
  ...
  get_marks:        '查看标记',
  orbit_inspect:    '环绕巡检',
  set_fleet_size:   '\u8c03\u6574\u673a\u961f\u89c4\u6a21',
  swarm_area_search: '\u591a\u673a\u533a\u57df\u641c\u7d22',
  swarm_perimeter_patrol: '多机边界巡查',
  swarm_waypoint_inspection: '多机航点巡检',
  swarm_relay_deploy: '空中中继部署',
  swarm_escort_route: '编队护航',
...
const SKILL_DESCRIPTIONS = {
  ...
  set_fleet_size: 'Select the active UAV count before a mission and synchronize the world model, runtime, and simulator fleet.',
  swarm_area_search: 'Search a rectangular area with independent tracks or preserve a requested triangle, circle, line, or V formation in Mock mode.',
  swarm_perimeter_patrol: 'Assign phase-shifted routes so multiple UAVs patrol a rectangular boundary without bunching together.',
  swarm_waypoint_inspection: 'Distribute inspection points across the fleet and visit them concurrently on separated altitude layers.',
  swarm_relay_deploy: 'Place UAVs at evenly spaced positions between two endpoints to form an airborne communication chain.',
  swarm_escort_route: 'Maintain a collision-safe formation while escorting along a multi-waypoint route.',
...
const SKILL_DESCRIPTIONS_ZH = {
  ...
  set_fleet_size: '\u5728\u4efb\u52a1\u5f00\u59cb\u524d\u9009\u62e9\u6fc0\u6d3b\u65e0\u4eba\u673a\u6570\u91cf\uff0c\u5e76\u540c\u6b65\u4e16\u754c\u6a21\u578b\u3001\u8fd0\u884c\u65f6\u548c\u4eff\u771f\u673a\u961f\u3002',
  swarm_area_search: '\u5728 Mock \u6a21\u5f0f\u4e2d\u4ee5\u72ec\u7acb\u822a\u7ebf\u641c\u7d22\u77e9\u5f62\u533a\u57df\uff0c\u6216\u5728\u641c\u7d22\u5168\u7a0b\u4fdd\u6301\u6307\u5b9a\u7684\u4e09\u89d2\u5f62\u3001\u5706\u5f62\u3001\u76f4\u7ebf\u6216 V \u5f62\u7f16\u961f\u3002',
  swarm_perimeter_patrol: '为多架无人机分配错开相位的边界航线，完成矩形区域外围巡查。',
  swarm_waypoint_inspection: '将多个巡检点分配给机队，以分层高度并行完成航点巡检。',
  swarm_relay_deploy: '在两个通信端点之间均匀部署无人机，形成空中中继链路。',
  swarm_escort_route: '无人机编队沿多航点路线护航，全程保持安全间距与编队形状。',
...
const PARAM_LABELS = {
  ...
  count: 'Active UAV count (1-10)',
  reason: 'Mission sizing reason',
  area_center: 'Search center [N, E, D]',
  area_width: 'Search width (m)',
  area_height: 'Search height (m)',
  tracks_per_uav: 'Tracks per UAV',
  patrol_laps: 'Perimeter patrol laps',
  visual_duration: 'Mock animation duration',
  inspection_points: 'Inspection point list',
  start_position: 'Relay start [N, E, D]',
  end_position: 'Relay end [N, E, D]',
  min_spacing: 'Required minimum spacing (m)',
  route: 'Escort route waypoints',
  center_position: 'Formation center [N, E, D]',
  formation: 'coverage | triangle | circle | line | v',
  formation_spacing: 'Search formation spacing (m)',
...
const PARAM_LABELS_ZH = {
  ...
  count: '\u6fc0\u6d3b\u65e0\u4eba\u673a\u6570\u91cf\uff081-10\uff09',
  reason: '\u4efb\u52a1\u89c4\u6a21\u8c03\u6574\u7406\u7531',
  area_center: '\u641c\u7d22\u533a\u57df\u4e2d\u5fc3 [N, E, D]',
  area_width: '\u641c\u7d22\u533a\u57df\u5bbd\u5ea6\uff08\u7c73\uff09',
  area_height: '\u641c\u7d22\u533a\u57df\u9ad8\u5ea6\uff08\u7c73\uff09',
  tracks_per_uav: '\u6bcf\u67b6\u65e0\u4eba\u673a\u626b\u63cf\u7ebf\u6570',
  patrol_laps: '边界巡查圈数',
  visual_duration: 'Mock 动画时长',
  inspection_points: '巡检点列表',
  start_position: '中继起点 [N, E, D]',
  end_position: '中继终点 [N, E, D]',
  min_spacing: '要求的最小间距（米）',
  route: '护航路线航点',
  center_position: '编队中心 [N, E, D]',
  formation: 'coverage | triangle | circle | line | v',
  formation_spacing: '搜索编队间距（米）',
  spacing: '最小间距（米）',
  post_action: 'hold | orbit',
