...
Gazebo Harmonic sensor bridge for the AeroWeaver Web console.
...
class GzSensorBridge:
    ...
    def start(self) -> bool:
        ...
        keeping the rest of AeroWeaver usable.
        """
        if self.is_running:
            return True
    ...
    def _list_topics(self) -> List[str]:
        ...
        # topics below are enough for AeroWeaver's bundled model; listing topics
