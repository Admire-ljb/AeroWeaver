...
class AirSimDirectClient:
    ...
    def sim_get_object_pose(self, object_name: str) -> dict:
        """Return an object's pose in AirSim's global NED frame."""
        return self._rpc.call("simGetObjectPose", object_name) or {}

    def sim_set_object_pose(self, object_name: str, pose: dict, teleport: bool = True) -> bool:
        """Set an Unreal object's pose in AirSim's global NED frame."""
        return bool(self._rpc.call("simSetObjectPose", object_name, pose, teleport))
    ...
    def sim_get_images(self, requests: list, vehicle_name: str = "", external: bool = False) -> list:
        ...
        try:
            ...
            if "invalid number of arguments" in str(e) and not external:
    ...
    def get_distance_sensor_data(
        self,
        sensor_name: str = "BottomDistance",
        vehicle_name: str = "",
    ) -> dict:
    ...
    def get_imu_data(self, sensor_name: str = "", vehicle_name: str = "") -> dict:
        return self._rpc.call("getImuData", sensor_name, vehicle_name) or {}

    def get_gps_data(self, sensor_name: str = "", vehicle_name: str = "") -> dict:
        return self._rpc.call("getGpsData", sensor_name, vehicle_name) or {}

    def get_barometer_data(self, sensor_name: str = "", vehicle_name: str = "") -> dict:
        return self._rpc.call("getBarometerData", sensor_name, vehicle_name) or {}

    def get_magnetometer_data(self, sensor_name: str = "", vehicle_name: str = "") -> dict:
        return self._rpc.call("getMagnetometerData", sensor_name, vehicle_name) or {}
